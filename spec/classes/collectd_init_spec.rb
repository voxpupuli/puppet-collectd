...
describe 'collectd' do
 ...
 it do should contain_package('collectd').with(
   :ensure => 'installed'
 )
 end

 it do should contain_service('collectd').with(
   :ensure => 'running'
 )
 end

 it do should contain_file('collectd.conf').with(
  :content => nil
 )
 end

 it do should contain_file('collectd.d').with(
  :ensure => 'directory'
 )
 end
 ...
 context 'when purge_config is enabled' do
   ...
   it do should contain_file('collectd.conf').with_content(
    /^# Generated by Puppet$/
   )
   end
 ...
 context 'when custom package_name is set' do
   ...
   it do should contain_package('collectd-core').with(
     :ensure => 'installed'
   )
   end
 end
