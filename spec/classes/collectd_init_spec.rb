...
describe 'collectd' do
  ...
  context 'when purge_config is enabled' do
    ...
    it do
      should contain_file('collectd.conf').with_content(
        /^# Generated by Puppet$/
      )
    end
    ...
    context 'with typesdb => ["/path/to/types.db"]' do
      ...
      it { is_expected.to contain_file('collectd.conf').with_content /^TypesDB "\/path\/to\/types.db"/ }
    end
    ...
    context 'with include => ["/some/include/path"]' do
      ...
      it { is_expected.to contain_file('collectd.conf').with_content /^Include "\/some\/include\/path"/ }
    end
