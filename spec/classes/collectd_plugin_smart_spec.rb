  ...
  on_supported_os(baseline_os_hash).each do |os, facts|
    context "on #{os}" do
      ...
      context ':ensure => present and :disks => ["sda"]' do
        ...
        it "creates #{options[:plugin_conf_dir]}/10-smart.conf" do
      ...
      context ':ensure => absent' do
        ...
        it "does not create #{options[:plugin_conf_dir]}/10-smart.conf" do
          is_expected.to contain_file('smart.load').with(
            ensure: 'absent',
            path: "#{options[:plugin_conf_dir]}/10-smart.conf",
          )
      ...
      when 'RedHat'
        ...
        context ':manage_package => false on osfamily => RedHat' do
          ...
          it 'does not manage collectd-smart' do
