...
describe 'collectd::plugin::swap', :type => :class do
  ...
  context ':ensure => present, default params' do
    ...
    it 'Will create /etc/collectd.d/swap.conf' do
      should contain_file('swap.conf').with({
        :ensure  => 'present',
  ...
  context ':ensure => present, specific params, collectd version 5.0' do
    ...
    it 'Will create /etc/collectd.d/swap.conf for collectd < 5.2' do
      should contain_file('swap.conf').with({
        :ensure  => 'present',
        :path    => '/etc/collectd.d/swap.conf',
        :content => "# Generated by Puppet\nLoadPlugin swap\n\n<Plugin swap>\n  ReportByDevice false\n</Plugin>\n",
  ...
  context ':ensure => absent' do
    ...
    it 'Will not create /etc/collectd.d/swap.conf' do
      should contain_file('swap.conf').with({
        :ensure => 'absent',
        :path   => '/etc/collectd.d/swap.conf',
      })
