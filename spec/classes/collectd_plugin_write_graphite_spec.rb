  ...
  on_supported_os(baseline_os_hash).each do |os, facts|
    context "on #{os}" do
      ...
      context 'single carbon writer' do
        ...
        it "creates #{options[:plugin_conf_dir]}/write_graphite-config.conf" do
        ...
        it "creates #{options[:plugin_conf_dir]}/write_graphite-config" do
      ...
      context 'ensure is absent' do
        ...
        it 'does not create /etc/collectd.d/conf.d/write_graphite-config.conf' do
        ...
        it 'does not create /etc/collectd.d/conf.d/write_graphite-config' do
