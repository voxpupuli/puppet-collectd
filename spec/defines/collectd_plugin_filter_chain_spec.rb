  ...
  on_supported_os(baseline_os_hash).each do |os, facts|
    context "on #{os}" do
      ...
      context ':ensure => present and default parameters' do
        ...
        it "creates #{options[:plugin_conf_dir]}/filter-chain-MyChain.conf" do
      ...
      context ':ensure => present and set a default target' do
        ...
        it 'adds a default target with plugin set and options' do
      ...
      context ':ensure => absent' do
        ...
        it "removes file #{options[:plugin_conf_dir]}/filter-chain-MyChain.conf" do
