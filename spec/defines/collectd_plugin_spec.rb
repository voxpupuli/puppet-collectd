  ...
  on_supported_os(baseline_os_hash).each do |os, facts|
    context "on #{os}" do
      ...
      context 'loading a plugin on collectd <= 4.9.4' do
        ...
        it "creates #{options[:plugin_conf_dir]}/10-test.conf with the LoadPlugin syntax with brackets" do
      ...
      context 'loading a plugin on collectd => 4.9.3' do
        ...
        it "creates #{options[:plugin_conf_dir]}conf.d/10-test.conf with the LoadPlugin syntax without brackets" do
      ...
      context 'loading a plugin without flushinterval param set' do
        ...
        it "creates #{options[:plugin_conf_dir]}conf.d/10-test_without_flushinterval.conf without the setting: FlushInterval" do
      ...
      context 'loading a plugin with flushinterval set' do
        ...
        it "creates #{options[:plugin_conf_dir]}conf.d/10-test_flushinterval.conf with the setting: FlushInterval" do
